...
export default function Header (){
    return (
        <header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[10px] tracking-wide relative z-50'>
      <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
        <a href="javascript:void(0)"><Image src={Logo} alt="logo" className='w-20' />
        </a>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
              <Link href= "../blogs" className='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Blog</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
              <Link href= "../about" className='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>About</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
